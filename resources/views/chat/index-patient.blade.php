...
<div class="container mx-auto px-6 py-12 max-w-4xl">
    <h1 class="text-4xl font-bold text-[#2d4e57] mb-6">Messagerie</h1>
    ...
    <div class="glass-card p-0 overflow-hidden">
        ...
        @else
            <div class="divide-y divide-gray-100">
                ...
                <a href="{{ route('chat.conversation', $contact) }}" class="flex items-center gap-4 p-4 hover:bg-white/30 transition-colors">
                    ...
                    @php
                        $unreadCount = $contact->receivedMessages->where('receiver_id', Auth::id())->where('is_read', false)->count();
                    @endphp
                    @if($unreadCount > 0)
