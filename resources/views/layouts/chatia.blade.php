...
<body>
    ...
    <div class="min-h-screen flex" x-data="{
        ...
        <!-- ========================================= -->
        <!-- SIDEBAR (identique à patient.blade.php)    -->
        <!-- ========================================= -->
        ...
        <div class="flex-1 ml-[76px] transition-all duration-350 sidebar:hover:ml-[220px]">
            ...
            <!-- Header simplifié (pas de recherche, pas de notifications) -->
            <header class="sticky top-0 z-20 bg-cream/60 backdrop-blur-xl border-b border-white/40 px-6 py-3 flex items-center justify-between flex-wrap gap-4">
                <!-- Titre du chat (remplace la recherche) -->
                <div class="flex items-center gap-3">
                    <i class="fas fa-robot text-xl text-primary/60"></i>
                    <span class="font-display font-semibold text-primary text-lg">Assistant médical</span>
                </div>

                <!-- Actions (langue + profil) -->
            ...
            <!-- Main content (pleine largeur, sans panneau droit) -->
