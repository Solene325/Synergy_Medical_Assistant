    ...
    <style>
        ...
        * { scroll-behavior: smooth; }
        ...
        .map-container {
            border-radius: 1.5rem;
            overflow: hidden;
            box-shadow: 0 8px 24px -6px rgba(10,74,59,0.06);
            border: 1px solid rgba(255,255,255,0.5);
            height: 280px;
        }

        /* Badges de langue */
        .lang-flag { width: 24px; height: 16px; border-radius: 4px; object-fit: cover; }
        .lang-dropdown {
...
<body>
    ...
    <div class="min-h-screen flex" x-data="{
        ...
        setLang(code) {
            ...
            // Ici, vous pouvez appeler une fonction de traduction si nécessaire
        }
    }">
        ...
        <aside class="sidebar fixed top-0 left-0 h-full z-30 flex flex-col justify-between py-6 px-3">
            ...
            <div>
                ...
                <nav class="flex flex-col gap-1.5">
                    <a href="{{ route('dashboard.patient') }}" class="nav-item active">
        ...
        <!-- RIGHT PANEL                              -->
        <!-- ========================================= -->
        <aside class="hidden lg:block w-80 xl:w-96 h-screen sticky top-0 overflow-y-auto p-6 bg-white/30 backdrop-blur-sm border-l border-white/50">
            @yield('right-panel')
        </aside>
